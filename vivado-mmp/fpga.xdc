...
# System clocks
# 300 MHz
set_property -dict {LOC AD12 IOSTANDARD LVDS} [get_ports clk_300mhz_p]
set_property -dict {LOC AD11 IOSTANDARD LVDS} [get_ports clk_300mhz_n]
create_clock -period 3.3 -name clk_300mhz [get_ports clk_300mhz_p]
...
# set_false_path -from [get_pins {mmp_iddmm_sp_0/mm_iddmm_sub_0/addr_a_reg[0]/C}] -to [get_pins mmp_iddmm_sp_0/mm_iddmm_sub_0/carry_reg/D]
# set_false_path -from [get_pins {mmp_iddmm_sp_0/mm_iddmm_sub_0/addr_a_reg[1]/C}] -to [get_pins mmp_iddmm_sp_0/mm_iddmm_sub_0/carry_reg/D]
# set_false_path -from [get_pins mmp_iddmm_sp_0/mm_iddmm_sub_0/carry_reg/C] -to [get_pins mmp_iddmm_sp_0/mm_iddmm_sub_0/carry_reg/D]
# set_false_path -from [get_pins {mmp_iddmm_sp_0/mm_iddmm_sub_0/addr_a_reg[2]/C}] -to [get_pins mmp_iddmm_sp_0/mm_iddmm_sub_0/carry_reg/D]
